...
const teamMembers = [
  {
    ...
    bio: "Responsável pela implementação da interface e experiência do usuário.",
  ...
  },
  {
    ...
    bio: "Responsável pela arquitetura do servidor e integração com o banco de dados.",
  ...
  },
  {
    ...
    bio: "Responsável pelo design da interface e experiência do usuário.",
  ...
  return (
    <div className="about-container">
      <header className="about-header">
        <img src="/logo-doamais.png" alt="Logo Doa Mais" className="about-logo" />
