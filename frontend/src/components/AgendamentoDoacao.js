...
const AgendamentoDoacao = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			// axios retorna dados em response.data
			if (response.data.success) {
				setAppointmentId(response.data.data.id); // ou appointmentId, conforme backend
				setSubmitted(true);
			} else {
				throw new Error(
			...
			<div className="agendamento-page">
				<div className="agendamento-container">
					<div className="agendamento-card sucesso">
						...
						<p>
							<strong>Data:</strong>{" "}
							{new Date(formData.data_doacao).toLocaleDateString(
								"pt-BR"
							)}{" "}
							às {formData.horario}
						</p>
							...
							<div className="etapa">
								...
								<div className="form-group checkbox-group">
									<label>
										<input
											...
											onChange={handleChange}
										/>
										Possui doenças infectocontagiosas (HIV,
										hepatite, sífilis, etc.)?
									</label>
								</div>
								...
								<div className="termos-condicoes">
									...
									<div className="termos-texto">
										<p>
											Ao agendar minha doação de sangue,
											declaro que:
										</p>
										<ul>
											<li>
											...
											<li>
												...
												(menores de 18 precisam de
												autorização)
											</li>
											<li>Peso mais de 50kg</li>
											<li>Não estou em jejum</li>
											<li>
												Não ingeri bebidas alcoólicas
												nas últimas 12 horas
											</li>
											<li>
												Não fiz tatuagem ou piercing nos
												últimos 12 meses
											</li>
										</ul>
										<p>
											Estou ciente de que posso ser
											submetido(a) a testes para verificar
											minha aptidão para doação.
										</p>
									</div>
